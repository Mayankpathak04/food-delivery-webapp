      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-4 md:mb-0 ml-10">
            ...
            <p>Email: mayankdutt.pathak@gmail.com</p>
          </div>
          ...
          <div className="w-full md:w-1/4 mb-4 md:mb-0">
            ...
            <ul>
              <li><a href="https://github.com/Mayankpathak04" target="_blank" rel="noopener noreferrer">Github</a></li>
              ...
              <li><a href="https://www.linkedin.com/in/mayank-dutt-pathak/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-800 mt-16 pt-9 text-center ">
          <p className='mt-4'>&copy; {new Date().getFullYear()} Mayank Dutt Pathak. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
